...
#         cbs = list(zip(*ls)) # Use this for channel list
#         print(cbs)
#         # print(type(cbs))
#         # print(type(cbs[0]))
#         # print(var_dict)
...
#             # model setting
#             for c,b in zip(model_cbs, gm_cbs):
#                 print(c)
#                 print(b)
#                 cfg_n = cfg # reset
...
#                     is_and= ''
#                 count += 1
#                 cmd = 'CUDA_VISIBLE_DEVICES=1 PORT={} bash tools/dist_train.sh {} {} {}\nsleep 0.1s \n'.format(
#                     port, file_name, self.num_device, is_and)
#                 shfile.write(cmd)
#                 shfile.write('\n')
