...
class ClassificationDataset(BaseDataset):
    ...
    def evaluate(self,
        ...
        if 'accuracy' in metrics:
            ...
            # confmat = ConfusionMatrix(task="multiclass", num_classes=24)
            # print('\n')
            # print(confmat(torch.squeeze(pred, 0), target))

            # torch.save(scores, '/usr/data/OpenBioSeq/configs/benchmarks/classification/neuro/EEG_speech/cnn/cnn5/zyy300_init_output/output_{}.pt'.format(acc))
            # torch.save(target, '/usr/data/OpenBioSeq/configs/benchmarks/classification/neuro/EEG_speech/cnn/cnn5/zyy300_init_output/"label_{}.pt'.format(acc))
